...
export default function Main() {
  ...
  const answers = [
    "Mariazinha esta disposta a responder algumas perguntas?",
    "Você responderá com total sinceridade?",
    "Tem certeza de que deseja continuar?",
    !question ? "Flamengo é melhor que o Palmeiras?" : question,
  ]
              ...
              {!id ? (
                <>
                  <p className="font-semibold" align="center">"
                    <b>Uma vez Flamengo sempre Flameno</b> - Yago
                  </p>

                  <p align="center">Flameno</p>
